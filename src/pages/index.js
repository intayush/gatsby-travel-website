...
const IndexPage = () => {
  const nationalTripsRef = useRef(null)
  const internationalTripsRef = useRef(null)
  const testimonialsRef = useRef(null)
  const emailSectionRef = useRef(null)
  const isNationalTripsAboutToBeVisible = useInView(nationalTripsRef)
  ...
  console.log(isEmailSectionAboutToBeVisible)
  ...
  return (
    <Layout>
      ...
      <Content>
        ...
        <div ref={nationalTripsRef} className="intersection">
          {!isNationalTripsAboutToBeVisible && (
            <svg
        ...
        <Section id="trips">
          {isNationalTripsAboutToBeVisible && <LoadableNationalTrips />}
        </Section>
        ...
        <Section id="emailSection">
          {isEmailSectionAboutToBeVisible && <LoadableEmailSection />}
        </Section>
